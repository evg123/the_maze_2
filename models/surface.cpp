...
GLfloat Surface::verts_[] = {
	...
	-0.5f,  0.0f, -0.5f,  0.0f,  1.0f,  0.0f,    0.0f, 200.0f,  0.5f, 0.5f, 0.5f, 
	 0.5f,  0.0f,  0.5f,  0.0f,  1.0f,  0.0f,  200.0f,   0.0f,  0.5f, 0.5f, 0.5f, 
	 0.5f,  0.0f, -0.5f,  0.0f,  1.0f,  0.0f,  200.0f, 200.0f,  0.5f, 0.5f, 0.5f, 
